...
const booksCreate = () => {
    ...
    const categories_id = document.getElementById("categories_id").element.State.name;
...
const showBooksCreateBox = () => {
    Swal.fire({
        ...
        html:
            ...
            '<select id="categories_id" class="swal2-input" placeholder="categories_id">'+
...
const showBooksEditBox = async (id) => {
    ...
    Swal.fire({
        ...
        html:
            ...
            '<input id="categories_id" class="swal2-input" placeholder="categories_id" value="' + data.CategoryId +'">'+
            '<input id="publishers_id" class="swal2-input" placeholder="publishers_id" value="' + data.PublishingId +'">',
        focusConfirm: false,
        showCancelButton: true,
        preConfirm: () => {
            booksEdit();
