...
class BooksController {
  ...
  _validateData = async (data, id) => {
    const attributes = ['title', 'author', 'publication_year', 'email'];
    const book = {};
    ...
    if (await this._checkIfEmailExists(book.email, id)) {
      throw new Error(`The book with mail address "${book.email}" already exists.`);
    }
