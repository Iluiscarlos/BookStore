...
class CitiesController {
  ...
  delete = async (req, res, next) => {
    ...
    LogModel.create({
      action: 'City: '+req.params.name+' deleted.'
    });
    res.json({});
  }
  ...
  _validateData = async (data, id) => {
    ...
    if (await this._checkIfCityExists(city.name, id, city.StateId, city.cep)) {
  ...
  _checkIfCityExists = async (name, id, cep, StateId) => {
    const where = {
      name: name,
      cep: cep,
      StateId: StateId
